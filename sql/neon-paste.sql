-- =============================================================================
-- Gaming Store – إنشاء كامل لقاعدة PostgreSQL (Neon)
-- انسخ المحتوى كاملاً والصقه في SQL Editor في لوحة Neon.
--
-- مهم:
-- 1) شغّل هذا فقط على قاعدة فاضية (بدون نفس الأنواع/الجداول).
--    إذا شغّلتَ من قبل: npx prisma db push أو هذا السكربت سابقاً، ستحصل على أخطاء
--    "already exists" — لا تحتاج إعادة التشغيل.
-- 2) لإضافة بيانات تجريبية بكلمات مرور مشفّرة: من المشروع استخدم: npm run db:seed
-- =============================================================================
